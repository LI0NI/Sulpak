...
def get_html(url: str, catergory: str, headers: dict='', params: str=''):
...
def get_card_from_html(html: str) -> ResultSet:
    """Фунуция для чтения карточек из html кода
    """
...
def main(category):
    ...
    write_to_csv(list_of_cards, category)
    write_to_json(list_of_cards, category)
    
if __name__ == '__main__':
    # main('naushniki')
    print(get_last__page('smartfoniy'))
